...
def pytorch2caffe(proto_path, caffemodel_path):
    model = BigResNet('BigResNet', 3, 214)
    load_model(model, '../../checkpoints/BigResNet_latest.pth')
    model.eval()
...
if __name__=='__main__':
    pytorch2caffe('../../caffemodel/BigResNet.prototxt',  '../../caffemodel/BigResNet.caffemodel')

    net = BigResNet('BigResNet', 3, 214)
